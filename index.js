...
async function add_user(tgid){
    let nameid = await get_users_count()
    let qer = `INSERT INTO users (tgid,dgid,name,ship,coun,attr,task) VALUES (${tgid},0,${nameid},${random.int(0, 19)},${random.int(0, 19)},${random.int(0, 19)},${await get_task()});`
    const [rows, fields] = await pool.query(qer);
    console.dir(rows);
...
function get_info(arrname,id) {
    ...
    var infos = {
        ...
        niks:['Джонс','Джек Воробей','Блэк','Литтл','Уайт','Грин','Рэд','Адамс','Одли','Остин','Бейкер','Байер','Белл','Бенсон','Картер','Кларк','Дэвис','Дин','Роуз','Стюарт','Эдисон','Экман','Эванс','Поттер','Фрай','Фаррелл','Фишер','Фостер','Форман','Гейт','Гиббс','Гилмор','Хилл','Харди','Джексон','Найт','Миллер','Мур','Моррисон','Нейтан','Пейдж','Рамси','Треверс','Шерман','Тэйлор','Томпсон','Уолтер','Ватсон','Холмс','Вильямс','Юнг','Вайс','Вульф','Вуд','Грей','Гримм','Дарк','Дрейк','Кинг','Куин','Кросс','Лоуренс','Рид','Старк','Готье','Де Пабло','Эртон','Браун','Эмрис','Питерс','Мартис','Дэвлин','Кресс','Нотт','Лайт','Дэй','Ларум','Корнер','Дрим','Смит','Свон','Робинс','Марс','Мэй','Паркер','Томас','Кармайкл','Бри','Рассел','Грант','Сандерс','Пайп','Стронг','Уилсон','Флинт','Хофф','Черри','Шарп','Кэролл','Форд','Роджер','Тёрнер','Диас','Круз','Депп','Пауль','Бёрк','Блоксам','Бэгшот','Вэлш','Купер','Линд','Мортимер','Нельсон','Райт','Роули','Слай','Фокс','Бридж','Холланд']
    }
